...
public class EditNote extends Activity {
    ...
    //Param: noteView.text in param[0][0]
    private class SaveNote extends AsyncTask<String,Void,String>
    {
    	...
    	protected String doInBackground(String[]...params)
    	{
    		...
    		getRequest.append("http://groupnote.net78.net/editNote.php?noteID=");
    		getRequest.append(User.getUser().getNoteID());
    		getRequest.append("&content=");
    		getRequest.append(params[0][0]); //the note text
    	...
    	protected void onPostExecute(String result)
    	{
    		...
    		if(result.equals("false"))
    			Toast toast = Toast.makeText(getApplicationContext(), "Error syncing changes to server! Please try again.",Toast.LENGTH_SHORT);
    	}
    }
    ...
    private class GetNote extends AsyncTask<String, Void, String>
    {
    	...
    	protected String doInBackground(String...params)
    	{
    		...
    		getRequest.append("http://groupnote.net78.net/getNotesForSession.php?token=");
    		getRequest.append(User.getUser().getSessionCode());
    	...
    	private String getNoteID(String response)
    	{
    		String noteID;
    		String[] notes;
    		String[] users;
    		...
    		for(int i = 0; i < noteCount;i++)
    		{
    			...
    			while((tempchar=response.charAt(i)) != ';'){
    				tempstring.append(Character.toString(tempchar));
    			}
    		...
    		for(int i = 0; i < noteCount; i++)
    		{
    			if(users[i] == User.getUser().getSessionCode())
    				return notes[i];
    		}
    		return "";
    	}
